...
export default function Page() {
  const { services = [], emergencies = [] } = data || {};
      ...
      <header className="hero fade-in text-center py-16">
        <div className="container-app flex flex-col items-center gap-5">
          ...
          <img
            ...
            className="w-28 h-28 md:w-32 md:h-32 drop-shadow-[0_0_40px_var(--card-glow)] motion-safe:hover:scale-[1.03] transition-transform"
            loading="lazy"
          />
